...
const DONNEES_INITIALES = {
  entreprise: {
    ...
    adresse: "Madina, Commune de Matam — Conakry, Guinée",
    agence2: "Agence Sonfonia T7 — Conakry",
    telephone: "+224 612 39 83 18 / +224 625 81 36 46",
    email: "contact@africavision.com",
    rccm: "",
    nif: "",
    numCNSS: "",
    logo: "",
